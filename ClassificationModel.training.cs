...
namespace Uyen_LeThiPhuong_Lab5
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Uyen\Downloads\RESTAURANTSCORES.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=27,MinimumExampleCountPerLeaf=5,NumberOfTrees=5,MaximumBinCountPerFeature=139,FeatureFraction=0.9791575800352029,LearningRate=0.7986604034104537,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"RiskCategory"))      
